...
public class Bootstrap {
	...
	public static void main(String... args) {
		...
		// Child context
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext(new String[]{"context/example1/spring-config.xml"}, parent);
